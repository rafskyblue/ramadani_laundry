...
<head>
	...
	<title>Ramadani Laundry | Login</title>
...
<body>
	...
	<?php if (isset($_SESSION['login']) && isset($_SESSION['master'])) : ?>
		<script>window.location='http://localhost/ramadani_laundry/'</script>
	<?php endif ?> 
	...
	<div class="box">
		<div class="box-content">
			<div class="col box__left">
				<div class="logo">
					<img src="<?= url('_assets/img/logo/logolaundry.png') ?>" alt="">
				</div>
	...
	<div class="copyright">
		<p>Design by <a href="#" target="_blank">Ramadani</a> & <a href="#" target="_blank">Teknik Informatika</a></p>
	</div>
