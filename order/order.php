                        ...
                        <div class="container-paket">
                           <div class="col-paket">
                              <a href="<?=url('order/order_ck.php')?>" class="paket">
                                 <img src="<?=url('_assets/img/2.png')?>" alt="cuci komplit" width="160">
                                 <h4>Cuci Komplit</h4>
                              </a>
                           </div>
                           ...
                           <div class="col-paket">
                              <a href="<?=url('order/order_dc.php')?>" class="paket">
                                 <img src="<?=url('_assets/img/1.png')?>" alt="dry clean" width="160">
                                 <h4>Dry Clean</h4>
                              </a>
                           </div>
                           ...
                           <div class="col-paket">
                              <a href="<?=url('order/order_cs.php')?>" class="paket">
                                 <img src="<?=url('_assets/img/3.png')?>" alt="cuci satuan" width="160">
                                 <h4>Cuci Satuan</h4>
                              </a>
                           </div>
                        </div>
